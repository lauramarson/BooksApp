...
public final class BookDetailsQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Book: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, description: String, isFavorite: Bool) {
        self.init(unsafeResultMap: ["__typename": "Book", "id": id, "description": description, "isFavorite": isFavorite])
      }
